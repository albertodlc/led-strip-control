...
- [2. Sniffing Bluetooth packets and reverse engineering the commands](#sniffing-bluetooth-packets-and-reverse-engineering-the-commands)
  ...
  - [Enable USB debugging on your Android device and Bluetooth HCI Snoop Mode](#led-strip-control#enable-usb-debugging-on-your-android-device-and-bluetooth-hci-snoop-mode)
...
- [3. Creating an API-REST service](#creating-an-api-rest-service)
  ...
  - [RPI Bluetooth library (Bluepy)](#rpi-bluetooth-library-bluepy)
...
The information of this guide is based on the tutorials from:
  - **Led strip with Bluetooth Control**
    ...
    - [Github](https://github.com/madhead/saberlight/blob/master/protocols/Triones/protocol.md#speed) : Protocol info
  - **Server/API**
